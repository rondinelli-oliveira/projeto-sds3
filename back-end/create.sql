create table tb_sales (id bigint not null auto_increment, amount float, date date, deals integer, visited integer, seller_id bigint, primary key (id)) engine=InnoDB;
